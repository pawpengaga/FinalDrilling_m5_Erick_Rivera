...
<body>
    ...
    <div class="container mt-5">
        ...
        <c:if test="${not empty current_user}">
            <form action="/FinalDrilling_m5_Erick_Rivera/users?accion=edit" method="POST" class="mt-5 d-flex flex-column gap-4">
                <!-- COLUMNA 0 -->
                ...
                <div class="col-12 mx-auto d-flex flex-row gap-4">
                    ...
                    <div class="w-100">
                        ...
                        <input type="password" name="password" id="password" class="form-control" value="${current_user.password}" required />
                    </div>
                </div>
                <div>
