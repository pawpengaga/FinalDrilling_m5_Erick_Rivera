    ...
    <div class="container mt-5 h-auto">
        ...
        <section class="h-auto">
            <c:if test="${empty sessionScope.current_user}">
                <div class="mt-5">
                    <p>Para ver el contenido, <a href="login.jsp">inicia sesión</a></p>
                    <p>¿No tienes una cuenta? <a href="signup.jsp">Regístrate</a></p>
                </div>
            </c:if>
            <c:if test="${not empty sessionScope.current_user}">
                <div class="mt-5 mb-5 col-12" id="index-menu">
                    <nav class="nav nav-pills nav-fill gap-3 w-100">
                        <a class="nav-link py-4 display-5" href="#">Ver animal</a>
